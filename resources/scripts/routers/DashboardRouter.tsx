...
import Logo from '@/components/elements/TinVox';
    ...
    return (
        <Fragment key={'dashboard-router'}>
            <MainSidebar className='hidden lg:flex'>
                ...
                />
                <div className='skeleton-anim-4 relative flex flex-row items-center justify-between h-8'>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <button className='skeleton-anim-4 w-10 h-10 flex items-center justify-center rounded-md text-white hover:bg-[#ffffff11] p-2'>
                                <svg
                        ...
                        <DropdownMenuContent className='skeleton-anim-4 z-[99999]' sideOffset={8}>
                            {rootAdmin && (
                ...
                <ul data-pyro-subnav-routes-wrapper='' className='pyro-subnav-routes-wrapper'>
                    <NavLink to={'/'} end className='skeleton-anim-4 flex flex-row items-center' ref={NavigationHome}>
                    ...
                    <NavLink
                        ...
                        className='skeleton-anim-4 flex flex-row items-center'
