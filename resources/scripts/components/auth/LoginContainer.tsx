...
import Logo from '../elements/TinVox';
    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                ...
                password: string().required('Ingrese la contraseña de su cuenta.'),
            })}
        >
            {({ isSubmitting, setSubmitting, submitForm }) => (
                <LoginFormContainer className={`w-full flex`}>
                    ...
                    <h2 className='text-xl font-extrabold mb-2'>Acceso</h2>
                    <Field
                        id='usernameOrEmail'
                        type={'text'}
                    ...
                    <div className={`mt-6`}>
                        <Button
                            className={`skeleton-anim-2 relative mt-4 w-full rounded-full bg-brand border-0 ring-0 outline-none capitalize font-bold text-sm py-2`}
                            type={'submit'}
                            size={'xlarge'}
