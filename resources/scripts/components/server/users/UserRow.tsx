        ...
        <div className='flex flex-row rounded-sm p-3 transition bg-[#ffffff08] border-[1px] border-[#ffffff07]'>
            ...
            <div className={`ml-4`}>
                <p className={`font-medium text-center`}>
                    {subuser.twoFactorEnabled ? 'MFA habilitado' : 'deshabilitado'}
                </p>
                <p className={`text-xs text-zinc-500 uppercase hidden md:block`}>2FA habilitado</p>
            </div>
