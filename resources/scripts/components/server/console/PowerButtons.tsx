...
export default ({ className }: PowerButtonProps) => {
    ...
    // Maneja el clic en los botones de control del servidor.
    const onButtonClick = (
        ...
        if (instance) {
            if (action === 'start') {
                toast.success('¡Tu servidor está iniciando!');
    ...
    return (
        ...
        >
            <Dialog.Confirm
                ...
                title={'Detener proceso forzadamente'}
                confirm={'Continuar'}
                onConfirmed={onButtonClick.bind(this, 'kill-confirmed')}
            >
                Detener un servidor forzadamente puede llevar a corrupción de datos.
            </Dialog.Confirm>
