...
export default () => {
    ...
    const network = useChart('Red', {
        ...
        callback(opts, index) {
            return {
                ...opts,
                label: !index ? 'Entrada de Red' : 'Salida de Red',
        ...
        <>
            ...
            >
                <ChartBlock title={'Memoria'}>
                    <Line aria-label='Uso de Memoria' role='img' {...memory.props} />
                </ChartBlock>
            </div>
            <div
                className='transform-gpu skeleton-anim-2'
            ...
            >
                <ChartBlock
                    ...
                    legend={
                        <>
                            {/* FIXME: Añadir iconos aquí */}
                            {/* FIXME: Reemplazar con tooltip de Radix */}
                ...
                >
                    <Line aria-label='Actividad de Red. Actividad de descarga y subida' role='img' {...network.props} />
                </ChartBlock>
            </div>
        </>
    );
