    ...
    return (
        ...
        >
            <div className='flex flex-col gap-4 w-full h-full'>
                ...
                <p>
                    Este servidor está ejecutando una versión de Java no compatible y no puede iniciarse. Por favor,
                    selecciona una versión compatible de la lista a continuación para continuar con el inicio del
                    servidor.
                </p>
