...
export default () => {
    ...
    return (
        <ServerContentBlock className='!p-0' title={'File Manager'} showFlashKey={'files'}>
            <div className='skeleton-anim-4 px-2 sm:px-14 pt-2 sm:pt-14'>
                <ErrorBoundary>
                    ...
                    <div className={'skeleton-anim-4 flex flex-wrap-reverse md:flex-nowrap mb-4'}>
                        ...
                        <>
                            <div ref={parentRef} style={{ height: `calc(100vh - 194px)`, overflowY: 'scroll' }}>
                                <div
                                    ...
                                    className='skeleton-anim-4 p-1 border-[1px] border-[#ffffff12] rounded-xl ml-14 mr-12'
                                >
                                    <div className='relative w-full h-full mb-1 skeleton-anim-4'>
                                        <svg
                                        ...
                                        <input
                                            className='skeleton-anim-4 pl-14 py-4 w-full rounded-lg bg-[#ffffff11] text-sm font-bold'
                                            type='text'
                                            placeholder='Search'
