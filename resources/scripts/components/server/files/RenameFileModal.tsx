        ...
        <Formik onSubmit={submit} initialValues={{ name: files.length > 1 ? '' : files[0] || '' }}>
            {({ isSubmitting, values }) => (
                <Modal
                    ...
                    title={useMoveTerminology ? 'Mover archivos/carpetas' : 'Archivo/carpeta de cambio de nombre'}
                >
                        ...
                        <div className='w-full'>
                            ...
                            {useMoveTerminology && (
                                <p className={`mt-2 !text-xs break-all`}>
                                    <strong className={`text-sm text-zinc-200`}>Nueva ubicación: </strong>
                                    <Code>
                                        /root/
                            ...
                            <div className={`flex justify-end w-full my-6`}>
                                <Button>{useMoveTerminology ? 'Mover' : 'Renombrar'}</Button>
                            </div>
                        </div>
                    </Form>
                </Modal>
